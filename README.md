...
<img src="assets/stream_buddies.png" alt="StreamBuddies logo" width="6%">
...
<img src="assets/team10_StreamBuddies_poster.png" alt="StreamBuddies poster" width="10%">
...
## Tech Decisions
- Authentication: We chose to use signInWithPhoneNumber instead of other methods (e.g., email, Google, etc.) since using phone number is the most direct and convenient method for a mobile application. 

- [TMDB API](https://developer.themoviedb.org/): TMDB (The Movie Database) not only has a comprehensive collection of movies and TV shows, but also convenient API endpoints that support searching and filtering with clear documentation. It is also free for non-commercial use, which makes it perfect for the developing phase. The attribution is included at the bottom of the logged-in profile page. 
